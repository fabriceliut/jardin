...
Cette approche coopérative du projet permet d’impliquer dès le départ toutes les parties prenantes et de favoriser ainsi l’appropriation du projet tout en limitant les risques de pertes économiques et de temps lorsqu’un projet n’est pas réellement adapté aux différents besoins.

# Pour quoi la démarche est la plus adaptée ?

# Intégrer beaucoup de parties prenantes.

Très difficile d’intégrer beaucoup d’avis et de points de vue dans un projet avec une approche classique (les réunions par exemple). La co-construction crée l’environnement favorable à faire se rencontrer différents profils sous format d’ateliers coopératifs (en présence ou à distance).
...
Dès l'initiation de notre coopération, nous sommes en co-construction. Je commence par récolter les besoins spécifiques du projet, les contraintes, le contexte ainsi que toutes les informations sur les parties prenantes pour déterminer le niveau de complexité du projet et comment l’appréhender au mieux.

### Écriture du programme d’atelier
...
- Objectif en sortie et livrables nécessaires pour la suite
- Qui est présent et pourquoi ?
- Gestion des invitations
- Gestion logistique de la journée

### Facilitation & animation

Durant la journée, je tiens une posture facilitant les échanges, les interactions et le travail coopératif. Je suis également moteur de la dynamique de la journée, m’assurant que tous les participants sont bien intégrés, en énergie et satisfaits de leur présence et participation.
...
Je m’occupe avec vous de collecter les différents éléments de travail du groupe, que ce soit des boards papier ou que ce soit au format numérique (type board Miro ou Mural).
...
De ces priorisations je peux organiser la donnée et la structurer sous formes de différentes synthèses nécessaires à la compréhension des résultats et utilisables pour les besoins du projet suivant les objectifs déterminés ensemble en amont.

Je m’assure de ne pas perdre ou dénaturer la justesse des informations et de ne pas induire de vérités fausses en respectant toujours les apports bruts du groupe de travail.
...
## Faciliter avec vous jusqu’à votre autonomie
