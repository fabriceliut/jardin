...
L’idée centrale du modèle ? Plutôt que de fonctionner en silos, on mettait en commun nos dynamiques, nos projets, nos besoins et surtout nos ressources. Chacun gardait son identité, mais on avançait ensemble, en tissant des liens solides. L’objectif était simple : travailler plus efficacement pour renforcer le territoire et rendre chaque action plus cohérente avec les autres.
...
Nous croyons à une nécessité de faire autrement & surtout faire ensemble pour **revitaliser & renforcer le territoire**, c'est ainsi que **nous œuvrons à connecter et faciliter la mise en actions des acteurs locaux**, avec vous.
...
## Faire archipel ?
Qu'est-ce que ça veut bien dire ? Est-ce si différent que faire partie d'un collectif ou d'une entreprise ? Je tenterai d'apporter des pistes de réponses au fil du temps ici.
